...
describe('Service Tests', () => {
  describe('MacroProceso Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new MacroProceso(0, 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a MacroProceso', async () => {
      ...
      it('should update a MacroProceso', async () => {
        const returnedFromService = Object.assign(
          {
            code: 1,
            macroProceso: 'BBBBBB'
      ...
      it('should return a list of MacroProceso', async () => {
        const returnedFromService = Object.assign(
          {
            code: 1,
            macroProceso: 'BBBBBB'
      ...
      it('should delete a MacroProceso', async () => {
