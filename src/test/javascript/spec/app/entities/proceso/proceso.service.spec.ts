...
describe('Service Tests', () => {
  describe('Proceso Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Proceso(0, 0, 'AAAAAAA', 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Proceso', async () => {
      ...
      it('should update a Proceso', async () => {
        const returnedFromService = Object.assign(
          {
            code: 1,
            proceso: 'BBBBBB',
      ...
      it('should return a list of Proceso', async () => {
        const returnedFromService = Object.assign(
          {
            code: 1,
            proceso: 'BBBBBB',
      ...
      it('should delete a Proceso', async () => {
