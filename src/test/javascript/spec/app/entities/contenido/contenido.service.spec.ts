...
describe('Service Tests', () => {
  describe('Contenido Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Contenido(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Contenido', async () => {
      ...
      it('should update a Contenido', async () => {
        const returnedFromService = Object.assign(
          {
            actividad: 'BBBBBB',
            descripcion: 'BBBBBB',
      ...
      it('should return a list of Contenido', async () => {
        const returnedFromService = Object.assign(
          {
            actividad: 'BBBBBB',
            descripcion: 'BBBBBB',
      ...
      it('should delete a Contenido', async () => {
