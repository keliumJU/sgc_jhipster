...
/**
 * REST controller for managing {@link com.itp.sgc.domain.Elementos}.
 */
@RestController
@RequestMapping("/api")
public class ElementosResource {
    ...
    public ElementosResource(ElementosRepository elementosRepository) {
    ...
    public ResponseEntity<Elementos> createElementos(@RequestBody Elementos elementos) throws URISyntaxException {
        ...
        Elementos result = elementosRepository.save(elementos);
    ...
    public ResponseEntity<Elementos> getElementos(@PathVariable Long id) {
        ...
        Optional<Elementos> elementos = elementosRepository.findById(id);
